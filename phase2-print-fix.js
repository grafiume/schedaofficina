...
(function(){
  ...
  function buildDocument(){
    ...
    return '<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>'+title+'</title><style>'+css()+'</style></head><body>'+toolbar()+
      ...
      '<div class="sign"><div><strong>ESITO COLLAUDO</strong><br><br>&#9633; POSITIVO &nbsp;&nbsp; &#9633; NEGATIVO</div><div><strong>FIRMA RESPONSABILE</strong><br><br><br>DATA ____________________</div></div><div class="foot">GRAZIE PER AVER SCELTO LA NOSTRA OFFICINA</div></main>'+script()+'</body></html>';
  }
  function toolbar(){
