 ...
 * (see previous cell for detailed header)
 */
(function(){
  ...
  (function installFetch(){
    ...
    console.log(LOG, "fetch hook attivo con fingerprint, server-params, rewrite JSON");
  })();
  (function installRPC(){
    ...
    window.supabase.rpc = async function(fn, params){
      ...
      }catch(e){ console.warn(LOG, "rpc hook rewrite fallita:", e); }
      return out;
    };
    window.__EXACT_V8_RPC__ = true;
    console.log(LOG, "rpc hook attivo");
  })();
})();
