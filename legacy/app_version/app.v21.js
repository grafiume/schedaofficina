      ...
      try{
        listPhotos(r.id).then(paths=>{
          ...
          if(paths && paths.length){
            ...
            img.decoding='async'; img.loading='lazy'; img.fetchPriority='low'; img.decoding='async'; img.loading='lazy'; img.fetchPriority='low'; img.src = url;
            img.addEventListener('click', ()=>// removed lightbox);
          } else {
            img.alt='—';
          }
        }).catch(()=>{});
