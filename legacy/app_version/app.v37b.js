...
async function listPhotos(recordId){
  ...
  // 1) TRY storage prefixes ONLY IF absolutely needed (guarded, swallow errors)
  try{
    // new layout: records/{id}/...
    ...
    if (paths && paths.length) return paths;
  }catch(e){ /* ignore any CORS/network errors */ }
