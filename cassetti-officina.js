...
(function () {
'use strict';
const CASSETTI_OFFICINA = Array.from({ length: 50 }, (_, i) => `A${i + 1}`);
function getSb(client){return client||window.supabase||window.supabaseClient;}
function s(v){return String(v??'').trim();}
function normalizeCassetto(v){v=s(v).toUpperCase();if(!/^A([1-9]|[1-4][0-9]|50)$/.test(v)) throw 'Errore cassetto';return v;}
